...
return [
    ...
    'imports' => [
        ...
        '@nitsan/ns-license/all-licenses.js' => 'EXT:ns_license/Resources/Public/JavaScript/all-licenses.js',
        '@nitsan/ns-license/demo-modal.js' => 'EXT:ns_license/Resources/Public/JavaScript/demo-modal.js',
    ],
];
