 ...
 * t3pbootstrap:8890, 127.0.0.1, 127.0.0.1:8890, ::1.
 * Invalid: 8.8.8.8 / 192.168.0.1 (non-loopback IPs), assaasd (single-label without port).
 * @param {string} value
 * @returns {boolean}
 */
function isValidDomainFormat(value) {
  ...
  if (parsed.invalid || parsed.invalidPort) {
    return false;
  }
